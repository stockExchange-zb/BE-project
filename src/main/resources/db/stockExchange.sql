...
CREATE TABLE IF NOT EXISTS order_table (
    ...
    order_status enum('PENDING','COMPLETED','CANCELLED') NOT NULL DEFAULT 'PENDING' COMMENT '주문 상태',
...
CREATE TABLE IF NOT EXISTS execution (
    ...
    execution_buy_order_id bigint NULL COMMENT '매수 주문 체결',
    execution_sell_order_id bigint NULL COMMENT '매도 주문 체결',
    stock_id bigint NOT NULL COMMENT '주식 아이디',
